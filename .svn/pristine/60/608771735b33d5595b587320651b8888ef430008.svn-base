  ...
  extends CrsBaseBean
{
  ...
  public void insertIntoArchive(ActionEvent actionEvent) {
        BigDecimal statementNo =
            (BigDecimal) ADFUtils.getAttribute("DeliveryStatmentAttachPVO1Iterator", "StatementNo");
        ...
        if (statementNo != null && filePath != null) {
            DBTransactionImpl dbTransaction =
                (DBTransactionImpl) ADFUtils.getDefaultDBTransaction(); // Integration point
            ...
            try {
                ...
                for (Map<String, Object> documentInfo : documentsInfo) {
                    ...
                    BigDecimal documentPk =
                        (BigDecimal) documentInfo.get(deliveryType == GenConstants.INCOMING_DOCUMENT ?
                                                      "INCOMING_DOCUMENTS_FK" : "OUTGOING_DOCUMENTS_FK");
    ...
    private List<Map<String, Object>> retrieveDocumentsInfo(BigDecimal statementNo,
                                                            DBTransactionImpl dbTransaction) throws SQLException {
        ...
        try (PreparedStatement statement =
             dbTransaction.createPreparedStatement(retreiveDocumentByStatementNumberSQL, 1)) {
    ...
    private void insertDocumentArchive(int deliveryType, BigDecimal documentPk, String filePath, BigDecimal statementNo,
        ...
        try {
            BigDecimal archivePk =gen.common.GenLib.getPrimaryKeyValue(dbTransaction,
                                                          deliveryType == GenConstants.INCOMING_DOCUMENT ?
                                                          "CRS_INCOMING_ARCHIVE_SEQ" : "CRS_OUTGOING_ARCHIVE_SEQ");
            String tableName =
                deliveryType == GenConstants.INCOMING_DOCUMENT ? "CRS_INCOMING_ARCHIVE" : "CRS_OUTGOING_ARCHIVE";
